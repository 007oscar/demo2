...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { especialidad: @specialty.especialidad, expert_id: @specialty.expert_id } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { especialidad: @specialty.especialidad, expert_id: @specialty.expert_id } }
