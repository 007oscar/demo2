...
class AuthoritiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create authority" do
    assert_difference('Authority.count') do
      post authorities_url, params: { authority: { apellidos: @authority.apellidos, nombres: @authority.nombres, title_id: @authority.title_id } }
    end
  ...
  test "should update authority" do
    patch authority_url(@authority), params: { authority: { apellidos: @authority.apellidos, nombres: @authority.nombres, title_id: @authority.title_id } }
