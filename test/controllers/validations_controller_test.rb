...
class ValidationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create validation" do
    assert_difference('Validation.count') do
      post validations_url, params: { validation: { apellidos: @validation.apellidos, nombres: @validation.nombres, registry_id: @validation.registry_id } }
    end
  ...
  test "should update validation" do
    patch validation_url(@validation), params: { validation: { apellidos: @validation.apellidos, nombres: @validation.nombres, registry_id: @validation.registry_id } }
