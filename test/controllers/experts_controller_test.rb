...
class ExpertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expert" do
    assert_difference('Expert.count') do
      post experts_url, params: { expert: { apellidos: @expert.apellidos, nombres: @expert.nombres } }
    end
  ...
  test "should update expert" do
    patch expert_url(@expert), params: { expert: { apellidos: @expert.apellidos, nombres: @expert.nombres } }
